...
//        String s = "这是一组严峻的数字：我国肺癌每年新增发病约78.7万人，死亡约63.1万人，相当于每一分钟就有1.5人患上肺癌，约占所有恶性肿瘤新发病例的五分之一\n" +
//                "\n" +
...
//        String ss = "生气 焦虑 满意 抑郁 失望 情感痛苦 害怕 快乐 嫉妒 缺乏控制 情感缺乏 丢面子 自尊心差 负面评价 躯体感觉 衰退 惊讶 不确定 不公平 生气 烦恼 痛苦 好斗 激怒 狂怒 恼怒 疯狂 愤怒 好争吵 大怒 怨恨 怀恨在心 焦急 猛烈 激烈 焦虑 担忧 不安 发狂 扰乱 兴奋 慌乱 狂乱 烦躁 歇斯底里 神经质";
//
//        String sss = "爱心、健康、快乐、自信、诚实、智慧、热情、奉献、 财务自由、感恩、冒险、投资、 行动、有远见、学习、果 断、自律、勇敢、善良、真实、简单、梦想、坚持、忍耐、 幽默、平静、淡泊、清晰、准确、想象力、创造力、企图心、 希望、等待、勤俭";
//
//        String ssss = "fuck you";
