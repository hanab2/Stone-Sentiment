...
//    public static final String CORPUS_FOLDER = TestUtility.ensureTestData("搜狗文本分类语料库迷你版", "http://file.hankcs.com/corpus/sogou-text-classification-corpus-mini.zip");
    // public static final String CORPUS_FOLDER = TestUtility.ensureTestData("搜狗文本分类语料库迷你版", "data.model.搜狗文本分类语料库迷你版.zip");
    public static String CORPUS_FOLDER = "src\\main\\resources\\data\\model\\搜狗文本分类语料库迷你版";
    /**
     * 模型保存路径
     */
    public static String MODEL_PATH = "src\\main\\resources\\data\\model\\classification-model.ser";


    public static void main(String[] args) throws IOException, URISyntaxException {
        CORPUS_FOLDER =
                new File(Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResource("data/model/搜狗文本分类语料库迷你版")).toURI()).getAbsolutePath();
        MODEL_PATH =
                new File(Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResource("data/model/classification-model.ser")).toURI()).getAbsolutePath();
