...
public class DemoSentimentAnalysis {
     ...
     */
    public static String CORPUS_FOLDER = "F:/idea社区版/Stone-Sentiment/Stone-NLP/src/main/resources/data/model/ChnSentiCorp";
    ...
    static {
        try {
            CORPUS_FOLDER = new File(Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResource("data/model/ChnSentiCorp")).toURI()).getAbsolutePath();
